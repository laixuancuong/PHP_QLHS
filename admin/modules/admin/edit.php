            ...
            <form action="" method="post" name="form_logo" enctype="multipart/form-data">
                ...
                while ($row = mysqli_fetch_assoc($ud_ad)) {
                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <input type="text" id="add_" name='username' value="<?php echo $row['username']; ?>"
                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <input type="text" id="add_" name='hoten' value="<?php echo $row['hoten']; ?>"
                                placeholder="Tên">
                        </div>
                    </div>
                    <div class="row row-login">
                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <input type="text" id="add_" name='dienthoai' value="<?php echo $row['dienthoai']; ?>"
