            ...
            <form action="../../libraries/function.php" method="post" name="form_logo" enctype="multipart/form-data">
                ...
                <div class="row row-login">
                    <p style="width: 250px; float: left; padding-right: 20px;"><b>Ngày sinh </b><input type="date"
                            min="2000-01-01" style="width: 220px;" name="ngaysinh" size="15" class="gia" id="add_"></p>
                    ...
                    <p style="width: 250px; float: left; padding-right: 20px;"><b>Số điện thoại: </b><input type="text"
                            name="sodt" size="15" class="xx" id="add_"></p>
                    <p style="width: 260px; float: left; padding-right: 20px;"><b>Email: </b><input type="text"
                            name="email" size="15" class="xx" id="add_"></p>
                    <div>
