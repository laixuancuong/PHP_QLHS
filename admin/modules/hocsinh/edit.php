            ...
            <form action="" method="post" name="form_logo" enctype="multipart/form-data">
                ...
                while ($row = mysqli_fetch_assoc($ud_hs)) {
                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <input type="text" id="add_" name='hoten_dem' value="<?php echo $row['hoten_dem']; ?>"
                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <input type="text" id="add_" name='ten_hs' value="<?php echo $row['ten_hs']; ?>"
                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <input type="text" id="add_" name='matkhau' value="<?php echo $row['matkhau']; ?>"
                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <input type="text" id="add_" name='diachi' value="<?php echo $row['diachi']; ?>"
                                placeholder="Địa chỉ">
                        </div>
                    </div>
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <input type="text" id="add_" name='sodt' value="<?php echo $row['sodt']; ?>"
                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <input type="text" id="add_" name='email' value="<?php echo $row['email']; ?>"
                                placeholder="Email">
                        </div>
                    </div>
                    <div class="row row-login">
                        <p style="width: 250px; float: left; padding-right: 20px;"><b>Ngày sinh </b><input type="date"
                                min="2000-01-01" style="width: 220px;" name="ngaysinh"
                                value="<?php echo $row['ngaysinh']; ?>" size="5" class="gia" id="add_"></p>

                        <p style="width: 200px; float: left; padding-right: 20px;"><b>Khoá:</b>
                            <select name="id_khoahoc" class="tmn" id="add_">
                                <option value="<?php echo $row['id_khoahoc']; ?>">
