                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <select name="magv" class="tmn" id="add_">
                                <option value="<?php echo $rows['magv']; ?>">
                                    <?php echo " " . $rows['hoten_dem'] . " " . $rows['ten_gv'] . ""; ?>
                                </option>
                                <?php
                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <select name="malh" class="tmn" id="add_">
                                <option value="<?php echo $rows['malh']; ?>">
                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <select name="id_namhoc" class="tmn" id="add_">
                                <option value="<?php echo $rows['id_namhoc']; ?>">
                                    <?php echo $rows['namhoc']; ?>
                                </option>
                                <?php
