                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <select name="mahs" class="tmn" id="add_">
                                <option value="<?php echo $rows['mahs']; ?>">
                                    <?php echo " " . $rows['hoten_dem'] . " " . $rows['ten_hs'] . ""; ?>
                                </option>
                                <?php
                    ...
                    <div class="row row-login">
                        ...
                        <div class="col-75">
                            <select name="id_pc_cn" class="tmn" id="add_">
                                <option value="<?php echo $rows['id_pc_cn']; ?>">
                                    <?php echo " " . $rows['tenlop'] . " - Chủ nhiệm: " . $rows['ten_gv'] . " - Năm học: " . $rows['namhoc'] . ""; ?>
                                </option>
                                <?php
