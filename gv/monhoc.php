    ...
    <div class="wrap-main">
        ...
        <div class="list-main">
            <div class="list-row">
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <select name='id_namhoc' type='submit' class="subject-select"
                                                    ...
                                                    <td>
                                                        <span style="margin-right: 10px;"><button style=" height: 30px;"
                                                                class="btn-ct info" name="search-mon"><i
                ...
                <!--end-panel-header-->
                <form action="../libs/function.php" method="POST">
            ...
            <div class="list-row">
                <div class="topnav">
                    <a class="active" href="../gv/index.php">Trang chủ</a>
