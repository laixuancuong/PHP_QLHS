...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../libs/css/box_show.css">
    <link rel="stylesheet" type="text/css" href="../libs/css/news.css">
    <link rel="stylesheet" type="text/css" href="../libs/css/list_row.css">
                ...
                <ul>
                    <li>
                        <div class="dropdown-icon">
                            <div class="dr-icon">
                                <a class="dropbtn" href="#" onclick="myFunction1()" role="button"><i
                                        class="fas fa-th"></i></a>
                            </div>
                            <div id="ud" class="dropdown-content">
                                <a href="">
                                    <span class="item-icon-small">
                                        <img src="../libs/img/logo.png"></span>
                                    <span class="item-icon-title">Trang Web</span>
                                </a>
                                <a href="">
                                    <span class="item-icon-small">
                                        <img src="../libs/img/thong_bao.png"></span>
                    ...
                    <li>
                        <div class="dropdown-icon">
                            <div class="dr-icon">
                                <a class="dropbtn" href="#" onclick="myFunction2()" role="button"><i
                            ...
                            <div id="us" class="dropdown-content">
                                <table class="list-item" style="width: 100%">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="hoso.php"><i class="fa fa-address-card" aria-hidden="true"
                                        ...
                                        <tr>
                                            <td>
                                                <a href="#"><i class="fa fa-question-circle" aria-hidden="true"
                                                        style="margin-right: 10px"></i><span class="item-icon-title">Báo
                                                        lỗi</span></a>
                                            </td>
                                        </tr>
                                    </tbody>
                                ...
                                <a href="./logout.php" class="btn-logout">
                                    <button id="btnLogout" type="button" class="btn lg"><i
                                            class="fas fa-sign-out-alt"></i><span class="lg">Đăng
                                            xuất</span></button>
                                </a>
                            </div>
                        </div>
