...
--
-- Máy chủ: localhost
-- Thời gian đã tạo: Th4 08, 2024 lúc 04:25 PM
...
CREATE TABLE `baitap` (
  `mabt` int NOT NULL,
  `noidung` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `malh` int NOT NULL,
  `mamh` int NOT NULL,
...
CREATE TABLE `giaovien` (
  `magv` int NOT NULL,
  `hoten_dem` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `ten_gv` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `password` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `chucvu` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `gioitinh` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `diachi` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `sodt` varchar(11) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `email` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
...
(10, 'ad', 'e', '123', '', 'Nam', 'a', '123', '@123', 1, 0, '2021-01-01'),
(11, 'Trần Văn', 'Lộc', '123', '', 'Nam', 'abn', '123123', 'a@gn', 1, 0, '2021-01-01'),
(12, 'Nguyễn Thị', 'Lý', '123', '', 'Nam', 'ab', '4324', '@dsd', 1, 0, '2021-01-01'),
(13, 'Trương Quang', 'Ninh', '123', '', 'Nam', 'a', '0987654321', 'lax@gmail.com', 1, 0, '2021-01-01');
...
CREATE TABLE `hoclieu` (
  `mahl` int NOT NULL,
  `noidung` varchar(50) COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `file_kem` varchar(250) COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `mapc` int NOT NULL,
...
(1, 'bài kiểm tra', 'file_tailieu/pv.docx', 53, '2024-04-08 23:20:37');
...
CREATE TABLE `hocsinh` (
  `mahs` int NOT NULL,
  `hoten_dem` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `ten_hs` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `matkhau` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
...
(12, 'Nguyễn Văn', 'Anh', '123', '2001-01-13', 'Nam', '12 số 453', '12355', 'lx@gmail.com', 1, 4, '2021-01-01 10:11:12'),
(13, 'Lại Xuân', 'Anh', '123', '2001-01-05', 'Nam', 'Số 45', '34234', 'nb@gmail.com', 1, 4, '2021-01-01 10:11:12'),
(14, 'Nguyễn Thị', 'Bình', '123', '2001-01-05', 'Nữ', '45 số jfjf', '34236', 'b@gmail,com', 1, 4, '2021-01-01 10:11:12'),
(15, 'Nguyễn Thị', 'Như', '123', '2001-01-05', 'Nữ', 'Số 153', '12387', 'C@gmail.com', 1, 4, '2021-01-01 10:11:12'),
...
(23, 'a', 'bb', '123', '2000-11-10', 'Nam', 'aff', '12333', '@1', 1, 3, '2021-01-19 17:55:31'),
...
(35, 'Nguyễn Văn', 'Lâm', '123', '2014-02-19', 'Nam', '12 số 453', '123', 'a@gmail.com', 1, 4, '2024-04-08 22:05:27');
...
CREATE TABLE `khoi` (
  `makhoi` int NOT NULL,
  `tenkhoi` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_vietnamese_ci;
...
CREATE TABLE `lop` (
  `malh` int NOT NULL,
  `tenlop` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `makhoi` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_vietnamese_ci;
...
CREATE TABLE `monhoc` (
  `mamh` int NOT NULL,
  `tenmh` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_vietnamese_ci;
...
INSERT INTO `news` (`id_news`, `nd_chinh`, `noidung`, `id_account`, `ngay_dang`) VALUES
...
(22, 'Dự định năm 2024', 'aqưeqwe', 5, '2024-04-08 22:30:09');
...
CREATE TABLE `phonghoc` (
  `maph` int NOT NULL,
  `chucnang` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `succhua` int NOT NULL,
  `chuthich` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_vietnamese_ci;
...
CREATE TABLE `thoikhoabieu` (
  `mapc` int NOT NULL,
  `buoihoc` varchar(30) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `maph` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_vietnamese_ci;
...
CREATE TABLE `tinnhan` (
  `matn` int NOT NULL,
  `tieude` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `noidung` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_vietnamese_ci NOT NULL,
  `thoigian` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_vietnamese_ci;
...
ALTER TABLE `diem_chitiet`
  ...
  ADD KEY `mahs` (`mahs`,`mamh`,`id_kyhoc`),
  ADD KEY `mamh` (`mamh`),
...
ALTER TABLE `diem_tk`
  ...
  ADD KEY `mahs` (`mahs`,`id_namhoc`,`mamh`),
...
ALTER TABLE `phancong`
  ...
  ADD KEY `id_namhoc` (`id_namhoc`,`id_cn_gv`,`id_pc_cn`),
...
ALTER TABLE `phancong_cn`
  ...
  ADD KEY `magv` (`magv`,`malh`,`id_namhoc`),
  ADD KEY `id_namhoc` (`id_namhoc`),
  ADD KEY `malh` (`malh`);
...
--
ALTER TABLE `diem_chitiet`
  MODIFY `id_diem_ct` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT cho bảng `diem_tk`
--
ALTER TABLE `diem_tk`
  MODIFY `id_diem_tkm` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT cho bảng `giaovien`
--
ALTER TABLE `giaovien`
  MODIFY `magv` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `hoclieu`
--
ALTER TABLE `hoclieu`
  MODIFY `mahl` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `hocsinh`
--
ALTER TABLE `hocsinh`
  MODIFY `mahs` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- AUTO_INCREMENT cho bảng `khoahoc`
--
ALTER TABLE `khoahoc`
  MODIFY `id_khoahoc` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `khoi`
--
ALTER TABLE `khoi`
  MODIFY `makhoi` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `kyhoc`
--
ALTER TABLE `kyhoc`
  MODIFY `id_kyhoc` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT cho bảng `lop`
--
ALTER TABLE `lop`
  MODIFY `malh` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT cho bảng `monhoc`
--
ALTER TABLE `monhoc`
  MODIFY `mamh` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `namhoc`
--
ALTER TABLE `namhoc`
  MODIFY `id_namhoc` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `news`
--
ALTER TABLE `news`
  MODIFY `id_news` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT cho bảng `phancong`
--
ALTER TABLE `phancong`
  MODIFY `mapc` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=66;

--
-- AUTO_INCREMENT cho bảng `phancong_cn`
--
ALTER TABLE `phancong_cn`
  MODIFY `id_pc_cn` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=51;

--
-- AUTO_INCREMENT cho bảng `phancong_lh`
--
ALTER TABLE `phancong_lh`
  MODIFY `id_pc_lh` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT cho bảng `phonghoc`
--
ALTER TABLE `phonghoc`
  MODIFY `maph` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tinnhan`
  MODIFY `matn` int NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `chucnang_gv`
  ADD CONSTRAINT `chucnang_gv_ibfk_1` FOREIGN KEY (`makhoi`) REFERENCES `khoi` (`makhoi`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chucnang_gv_ibfk_2` FOREIGN KEY (`mamh`) REFERENCES `monhoc` (`mamh`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `chucnang_gv_ibfk_3` FOREIGN KEY (`magv`) REFERENCES `giaovien` (`magv`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Các ràng buộc cho bảng `diem_chitiet`
--
ALTER TABLE `diem_chitiet`
  ADD CONSTRAINT `diem_chitiet_ibfk_1` FOREIGN KEY (`mahs`) REFERENCES `hocsinh` (`mahs`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `diem_chitiet_ibfk_2` FOREIGN KEY (`mamh`) REFERENCES `monhoc` (`mamh`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `diem_chitiet_ibfk_3` FOREIGN KEY (`id_kyhoc`) REFERENCES `kyhoc` (`id_kyhoc`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `lop`
  ADD CONSTRAINT `lop_ibfk_1` FOREIGN KEY (`makhoi`) REFERENCES `khoi` (`makhoi`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `phancong`
  ADD CONSTRAINT `phancong_ibfk_1` FOREIGN KEY (`id_pc_cn`) REFERENCES `phancong_cn` (`id_pc_cn`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `phancong_ibfk_2` FOREIGN KEY (`id_cn_gv`) REFERENCES `chucnang_gv` (`id_cn_gv`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `phancong_cn`
  ADD CONSTRAINT `phancong_cn_ibfk_1` FOREIGN KEY (`id_namhoc`) REFERENCES `namhoc` (`id_namhoc`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `phancong_cn_ibfk_2` FOREIGN KEY (`malh`) REFERENCES `lop` (`malh`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `phancong_cn_ibfk_3` FOREIGN KEY (`magv`) REFERENCES `giaovien` (`magv`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `phancong_lh`
  ...
  ADD CONSTRAINT `phancong_lh_ibfk_2` FOREIGN KEY (`id_pc_cn`) REFERENCES `phancong_cn` (`id_pc_cn`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
